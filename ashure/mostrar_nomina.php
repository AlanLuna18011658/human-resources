                   ...
                   echo' 
                     <tbody>
                        <tr class="tr-mostrar">
                           ...
                           <td class="mostrar">'.$mostrar['fecha_pago'].'</td>
                           <td class="mostrar">'.$mostrar['monto_bruto'].'</td>
                           <td class="mostrar">'.$mostrar['deducciones'].'</td>
                           <td class="mostrar">'.$mostrar['monto_neto'].'</td>
                           </tr>
                        </tbody>
                       ';
