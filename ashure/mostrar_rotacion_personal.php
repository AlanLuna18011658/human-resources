...
$empleado = "SELECT *
FROM empleado e
INNER JOIN rotacion_personal rp ON e.idempleado = rp.empleado_idempleado $where";
                   ...
                   echo' 
                     <tbody>
                        <tr class="tr-mostrar">
                           ...
                           <td class="mostrar">'.$mostrar['tipo'].'</td>
                           <td class="mostrar">'.$mostrar['motivo'].'</td>
                           <td class="mostrar">'.$mostrar['fecha'].'</td>
                           </tr>
                        </tbody>
                       ';
               }
