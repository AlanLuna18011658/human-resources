...
if (isset($_POST['buscar'])){
   if(empty($_POST['xnombrec'])){
      ...
      $where="where nombre_contacto='".$nombrec."'";
   }
else{
   ...
   <nav class="navbar navbar-expand-lg bg-body-tertiary">
      ...
      <div class="botones-buscar">
         ...
         <div class="select-contenedor">
            <h1>Consulta contacto de emergencia</h1>
            <input type="text" placeholder="Nombre..." name="xnombre"/>
            <select name="xnombrec" id="">
               <option value=""> Contacto...</option>
               <?php while ($resnombrec = $nombrec->fetch_array(MYSQLI_BOTH) ){
                  
                  echo '<option value="'.$resnombrec['nombre_contacto'].'">'.$resnombrec['nombre_contacto'].'</option>';
               }
                  ?>
            </select>
                   ...
                   echo' 
                     <tbody>
                        <tr class="tr-mostrar">
                           ...
                           <td class="mostrar">'.$mostrar['nombre_contacto'].'</td>
                           <td class="mostrar">'.$mostrar['relacion_contacto'].'</td>
                           <td class="mostrar">'.$mostrar['telefono_contacto'].'</td>
                           <td class="mostrar">'.$mostrar['correo_contacto'].'</td>
                           </tr>
                        </tbody>
                       ';
