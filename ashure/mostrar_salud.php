                   ...
                   echo' 
                     <tbody>
                        <tr class="tr-mostrar">
                           ...
                           <td class="mostrar">'.$mostrar['tipo_sangre'].'</td>
                           <td class="mostrar">'.$mostrar['alergias'].'</td>
                           <td class="mostrar">'.$mostrar['enf_cronicas'].'</td>
                           <td class="mostrar">'.$mostrar['historial_medico'].'</td>
                           <td class="mostrar">'.$mostrar['medico_cabecera'].'</td>
                           <td class="mostrar">'.$mostrar['contacto_medico'].'</td>
                           <td class="mostrar">'.$mostrar['ultima_revision_fecha'].'</td>
                           </tr>
                        </tbody>
                       ';
               }
