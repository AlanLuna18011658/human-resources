   ...
   <nav class="navbar navbar-expand-lg bg-body-tertiary">
      ...
      <div class="botones-buscar">
         <form method="post" action="">
            ...
            <button type="submit" name="limpiar" href="prueba.php" class="btn btn-primary">Limpiar</button>
            </div>
               ...
               { 
                  ...
                  <tbody>
                    ...
                    <tr class="tr-mostrar">
                           ...
                           <td class="mostrar">'. $mostrar['telefono'].'</td>
                           <td class="mostrar">'. $mostrar['genero'].'</td>
                           <td class="mostrar">'. $mostrar['calle'].'</td>
                           <td class="mostrar">'. $mostrar['ciudad'].'</td>
                           <td class="mostrar">'. $mostrar['estado'].'</td>
                           <td class="mostrar">'. $mostrar['cp'].'</td>
                           <td class="mostrar">'. $mostrar['correo'].'</td>
                           <td class="mostrar">'. $mostrar['fecha_contratacion'].'</td>
                           <td class="mostrar">'. $mostrar['cargo'].'</td>
                           <td class="mostrar">'. $mostrar['departamento'].'</td>
                           <td class="mostrar">'. $mostrar['salario'].'</td>
                           <td class="mostrar">'. $mostrar['activo'].'</td>
